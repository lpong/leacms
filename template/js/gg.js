...
TransformView.prototype = {
  ...
  initialize: function(container, slider, parameter, count, options) {
	...
	var oContainer = a(container), oSlider = a(slider), oThis = this;
...
window.onload=function(){
	...
	var objs2 = a("idNum2").getElementsByTagName("li");
	var tv2 = new TransformView("idTransformView2", "idSlider2", 217, tpz, {	
